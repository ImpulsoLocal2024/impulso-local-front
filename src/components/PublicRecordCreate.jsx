  ...
  useEffect(() => {
    const fetchFieldsData = async () => {
      try {
        ...
        // Filtrar los campos para excluir 'Estado' y 'Asesor'
        const filteredFields = fieldsResponse.data.filter(
          (field) => !['estado', 'asesor'].includes(field.column_name.toLowerCase())
        );
        ...
        console.log('Datos relacionados obtenidos:', relatedDataResponse.data);
